...
<section class="main-content">
    ...
    <?php $form = QuestionForm::begin('', 'post') ?>
        <label for="dataList" class="form-label">Select a module</label>
        <input class="form-control" autocomplete="off" list="datalistOptions" id="dataList" placeholder="Type to search...">
